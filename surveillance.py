...
class App:
	...
	def viewdetail(self,a):
		...
		for row in rows:
			...
			label_g = Label(self.window, text=row[3],bg="#382273",fg='white',width=20,font=("bold", 12))
			label_g.place(x=1130,y=460)
			label_r = Label(self.window, text=row[4],bg="#382273",fg='white',width=20,font=("bold", 12))
			label_r.place(x=1130,y=490)
			label_bl = Label(self.window, text=row[5],bg="#382273",fg='white',width=20,font=("bold", 12))
			label_bl.place(x=1130,y=520)
			label_b = Label(self.window, text=row[6],bg="#382273",fg='white',width=20,font=("bold", 12))
			label_b.place(x=1130,y=550)
			label_n = Label(self.window, text=row[7],bg="#382273",fg='white',width=20,font=("bold", 12))
			label_n.place(x=1130,y=580)
			label_c = Label(self.window, text=row[8],width=30,bg="#382273",font=("bold", 15),fg="red")
			label_c.place(x=1060,y=610)
		conn.close()
